...
public class PlayerMaximum extends PlaceHolder {

	public PlayerMaximum() {
		super("%playerMaximum", GameState.WAITING, GameState.INGAME, GameState.FINISH);
	}

	@Override
	public String process(Game game, Player p, final Sideline sl, String conserned) {
		return conserned.replace(this.getName(), ""+ game.getMaxPlayers());
	}
