...
package net.upd4ting.gameapi.schematic.jnbt;

import java.util.Map;

import net.upd4ting.gameapi.exception.InvalidFormatException;
...
public final class NBTUtils {
     ...
     * @return child tag
     * @throws InvalidFormatException The excption that is thrown
     */
